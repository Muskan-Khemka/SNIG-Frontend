...
import backgroundImage from "../../Images/dashboard2.jpg";
import "./home.css";
import Pricing from "../pricing";
import Moviesgrid from "../MoviesGrid/Moviesgrid";
import Playbackvedio from "../playbackvedio/Playbackvedio";
...
const HomePage = () => {
  return (
    <div>
      <Header />
      <section className="text-gray-600 body-font opacity-90 bg-[url('/src/Images/dashboard4.jpg')]">
