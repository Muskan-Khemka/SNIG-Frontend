          ...
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <span class="flex items-center">
                ...
                <a href="#">
                  <span class="text-gray-600 ml-3 underline">415 Reviews</span>
                </a>
                <a href="#">
                  <span class="text-gray-600 ml-3 underline">
                    Critic Reviews
                  </span>
                </a>
              </span>
              <div class="flex mb-4">
                ...
                <a
                  class="flex-grow border-b-2 border-gray-300 py-2 text-lg text-black px-1"
                  href="#"
                >
                  Reviews
                </a>
              ...
              <p class="leading-relaxed text-black mb-4">
              ...
              <div class="flex">
                <span class="title-font text-sm text-gray-900">
                  See production info at IMDbPro
                </span>
                <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">
                  Add to Watchlist
                </button>
              ...
              <button class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-start hover:bg-gray-200 focus:outline-none mt-5">
                <span class="text-xs text-gray-600 mb-1 mr-2">
                  Streaming on
                </span>
                <br></br>
                <svg
                ...
                <span class="ml-4 flex items-start flex-col leading-none"></span>
              </button>
