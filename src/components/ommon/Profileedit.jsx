    ...
    <div className="flex justify-center items-center h-screen bg-gray-900">
      <div className="card bg-gray-800 shadow-lg rounded-lg p-4 sm:p-8 max-w-3xl w-full">
        ...
        <div className="bg-ivory-200 rounded-lg border-dashed border border-gray-400 text-center py-2 sm:py-4 px-4 sm:px-6 mb-4 sm:mb-6">
          ...
          <button className="bg-yellow-500 text-blue-900 px-3 py-1 sm:px-4 sm:py-2 rounded mt-2 sm:mt-4 transition duration-300 hover:bg-yellow-600 text-xs sm:text-sm w-full" onClick={handleChangeSubscription}>
            Upgrade Now
          </button>
        </div>

        <div className="mb-2 sm:mb-4 flex justify-between items-center">
          <button className="bg-gray-300 text-gray-700 px-3 py-1 sm:px-4 sm:py-2 rounded w-full transition duration-300 hover:bg-gray-400 text-xs sm:text-sm" onClick={handleChangePassword}>
            Change Password
          </button>
        </div>

        <div className="flex justify-between">
          <button className="bg-blue-500 text-white px-3 py-1 sm:px-4 sm:py-2 rounded w-full transition duration-300 hover:bg-blue-600 text-xs sm:text-sm" onClick={handleSaveChanges}>
            Save Changes
          </button>
        </div>

        <div className="mt-2 sm:mt-4">
          <button className="bg-red-500 text-white px-3 py-1 sm:px-4 sm:py-2 rounded w-full transition duration-300 hover:bg-red-600 text-xs sm:text-sm" onClick={handleDeleteAccount}>
            Delete Account
          </button>
        </div>
      </div>
